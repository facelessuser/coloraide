...
class TestOkLChInputOutput(util.ColorAsserts, unittest.TestCase):
    ...
    def test_precision(self):
        ...
        self.assertEqual(
            ...
            'oklch(0.12345599999999999629718416827017790637910366058349609 0.12345599999999999629718416827017790637910366058349609 0.12345599999997602935764007270336151123046875)'  # noqa:  E501
        )
