...
class TestNull(util.ColorAsserts, unittest.TestCase):
    ...
    def test_auto_null(self):
        ...
        c = Color('color(jzczhz 90% 0 120 / 1)')
        self.assertTrue(c.is_nan('hue'))
    ...
    def test_near_zero_null(self):
        ...
        c = Color('color(jzczhz 90% 0.00009 120 / 1)')
        self.assertTrue(c.is_nan('hue'))
...
class TestQuirks(util.ColorAsserts, unittest.TestCase):
    ...
    def test_chorma_less_than_zero_convert(self):
        ...
        self.assertColorEqual(Color('color(jzczhz 90% -10 120 / 1)').convert('jzazbz'), Color('color(jzazbz 0.9 0 0)'))
