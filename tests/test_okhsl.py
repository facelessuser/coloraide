...
class TestsOkhsl(util.ColorAssertsPyTest):
    ...
    COLORS = [
        ...
        ('indigo', 'color(--okhsl 301.68 1 0.24043)'),
        ('violet', 'color(--okhsl 327.21 0.90625 0.7231)'),
        ('white', 'color(--okhsl 0 0 1)'),
...
class TestOkhslSerialize(util.ColorAssertsPyTest):
    ...
    COLORS = [
        ...
        ('color(--okhsl 50 -1.1 0.5)', {}, 'color(--okhsl 230 0.1676 0.5)')
    ]
...
class TestOkhslProperties(util.ColorAsserts, unittest.TestCase):
    ...
    def test_names(self):
        ...
        self.assertEqual(Color('color(--okhsl 120 50% 90% / 1)')._space.names(), ('h', 's', 'l'))
