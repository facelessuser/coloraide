...
class TestAPI(util.ColorAsserts, unittest.TestCase):
    ...
    def test_delta_e_jz(self):
        """Test delta e Jz."""

        self.assertCompare(
            Color('red').delta_e('red', method="jz"),
            0.0,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('orange', method="jz"),
            0.0941,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('yellow', method="jz"),
            0.1663,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('green', method="jz"),
            0.1996,
            rounding=4
        )
        self.assertCompare(
        ...
        self.assertCompare(
            Color('red').delta_e('indigo', method="jz"),
            0.2401,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('violet', method="jz"),
            0.1785,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('black', method="jz"),
            0.2109,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('white', method="jz"),
            0.1848,
            rounding=4
        )
        self.assertCompare(
            Color('red').delta_e('gray', method="jz"),
            0.1635,
            rounding=4
        )
        ...
        self.assertCompare(
            Color('orange').delta_e('red', method="jz"),
            0.0941,
            rounding=4
        )
        self.assertCompare(
            Color('yellow').delta_e('red', method="jz"),
            0.1663,
            rounding=4
        )
        self.assertCompare(
            Color('green').delta_e('red', method="jz"),
            0.1996,
            rounding=4
        )
        self.assertCompare(
            Color('blue').delta_e('red', method="jz"),
            0.3396,
            rounding=4
        )
        self.assertCompare(
            Color('indigo').delta_e('red', method="jz"),
            0.2401,
            rounding=4
        )
        self.assertCompare(
            Color('violet').delta_e('red', method="jz"),
            0.1785,
            rounding=4
        )
        self.assertCompare(
            Color('black').delta_e('red', method="jz"),
            0.2109,
            rounding=4
        )
        self.assertCompare(
            Color('white').delta_e('red', method="jz"),
            0.1848,
            rounding=4
        )
        self.assertCompare(
            Color('gray').delta_e('red', method="jz"),
            0.1635,
            rounding=4
        )
