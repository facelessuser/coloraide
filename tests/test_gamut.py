...
class TestRayTrace(util.ColorAsserts, unittest.TestCase):
    ...
    def test_trace_face2(self):
        ...
        self.assertColorEqual(color.fit('srgb', method='oklch-raytrace'), Color('oklch(0.89953 0.0654 60.346)'))
    ...
    def test_trace_face4(self):
        ...
        self.assertColorEqual(color.fit('srgb', method='oklch-raytrace'), Color('oklch(0.89996 0.18164 150)'))
