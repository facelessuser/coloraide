...
class TestLch99oInputOutput(util.ColorAsserts, unittest.TestCase):
    ...
    def test_precision(self):
        ...
        self.assertEqual(
            ...
            'color(--lch99o 20.12345669999999842048055143095552921295166015625 10.1234567000000001968373908312059938907623291015625 130.1234567000000197367626242339611053466796875)'  # noqa:  E501
        )
...
class TestNull(util.ColorAsserts, unittest.TestCase):
    ...
    def test_real_achromatic_hue(self):
        ...
        self.assertEqual(Color('white').convert('lch99o')._space.achromatic_hue(), 0.0)
