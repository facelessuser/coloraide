...
models = {
    'cam02-jmh': {'title': TEMPLATE.format('CAM02 JMh'), 'filename': 'cam02-jmh-3d.png'},
    'cam02-lcd': {'title': TEMPLATE.format('CAM02 LCD'), 'filename': 'cam02-lcd-3d.png'},
    'cam02-scd': {'title': TEMPLATE.format('CAM02 SCD'), 'filename': 'cam02-scd-3d.png'},
    'cam02-ucs': {'title': TEMPLATE.format('CAM02 UCS'), 'filename': 'cam02-ucs-3d.png'},
    ...
    'hellwig-hk-jmh': {'title': TEMPLATE.format('Hellwig H-K JMh'), 'filename': 'hellwig-hk-jmh-3d.png'},
    'hellwig-jmh': {'title': TEMPLATE.format('Hellwig JMh'), 'filename': 'hellwig-jmh-3d.png'},
    'helmgen': {'title': TEMPLATE.format('Helmgen'), 'filename': 'helmgen-3d.png'},
    'helmgenlch': {'title': TEMPLATE.format('Helmgenlch'), 'filename': 'helmgenlch-3d.png'},
    'helmlab-metric': {'title': TEMPLATE.format('Helmlab Metric'), 'filename': 'helmlab-metric-3d.png'},
    'helmlch': {'title': TEMPLATE.format('Helmlch'), 'filename': 'helmlch-3d.png'},
    ...
    'ictcp': {'title': TEMPLATE.format('ICtCp'), 'filename': 'ictcp-3d.png', 'azim': 15},
