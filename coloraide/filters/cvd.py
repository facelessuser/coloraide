...
BRETTEL_PROTAN = (
    [
        [  0.                 ,   4.645203550257065  , -35.779576941742434  ],
        [  0.                 ,   3.1614562071112173 ,  -5.353537465326408  ],
        [  0.                 ,  -0.49202224438116643,  69.56547088528569   ]
    ],
    [
        [  0.                ,   4.500783062899838 , -32.818059625581405 ],
        [  0.                ,   3.179741536008844 ,  -5.728500319648271 ],
        [  0.                ,  -0.4913704825845725,  69.55210571887513  ]],
    [0.0, 0.016813516536000002, -0.344781556122]
)  # type: tuple[Matrix, Matrix, Vector]

BRETTEL_DEUTAN = (
    [
        [  2.0757138256610466 ,   0.                 , -21.409141476259606  ],
        [  1.466463363392979  ,   0.                 ,   2.3317439563667293 ],
        [ -0.22661490011149105,   0.                 ,  68.30654343816653   ]
    ],
    [
        [  2.124834794256137 ,   0.                , -23.323256212281898 ],
        [  1.4461308480260673,   0.                ,   3.124048513815847 ],
        [ -0.2250635463221503,   0.                ,  68.24609126806706  ]
    ],
...
BRETTEL_TRITAN = (
    [
        [  7.392856536180033  , -11.148044821248138  ,   0.                 ],
        [ -0.34194012421930653,   3.5501661175064    ,   0.                 ],
        [ -4.2050692716448586 ,  10.89115898202731   ,   0.                 ]
    ],
    [
        [  8.0643934576311   , -12.42414705871019  ,   0.                ],
        [ -0.9956078228581946,   4.7923119863996835,   0.                ],
        [ -0.2150297288038942,   3.3090019545637928,   0.                ]
    ],
    [0.344781556122, -0.6551784438780001, 0.0]
)  # type: tuple[Matrix, Matrix, Vector]

VIENOT_PROTAN = [
    [ 1.1238276122216405e-01,  8.8761723877783620e-01,  5.5511151231257830e-17],
    [ 1.1238276122216398e-01,  8.8761723877783620e-01, -2.7755575615628914e-17],
    [ 4.0057682730469425e-03, -4.0057682730469390e-03,  1.0000000000000000e+00]
]

VIENOT_DEUTAN = [
    [ 2.9275011427843560e-01,  7.0724988572156440e-01,  1.1102230246251565e-16],
    [ 2.9275011427843560e-01,  7.0724988572156440e-01, -5.5511151231257830e-17],
    [-2.2336587034129083e-02,  2.2336587034129093e-02,  1.0000000000000000e+00]
]

VIENOT_TRITAN = [
    [ 1.0000000000000002e+00,  1.4461224330693610e-01, -1.4461224330693630e-01],
    [ 3.4694469519536140e-17,  8.5923580780458990e-01,  1.4076419219541025e-01],
    [-4.1633363423443370e-17,  8.5923580780458960e-01,  1.4076419219541023e-01]
]
