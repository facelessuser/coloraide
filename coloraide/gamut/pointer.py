...
def to_lch_sc(color: TypeColor) -> Vector:
...
def from_lch_sc(color: TypeColor, lch: Vector) -> TypeColor:
...
def fit_pointer_gamut(color: TypeColor) -> TypeColor:
...
def in_pointer_gamut(color: TypeColor, tolerance: float) -> bool:
    """
